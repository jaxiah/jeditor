...
let emacs_default =
  ...
  |> bind [Key.Ctrl 'v']         "scroll-page-down"
  |> bind [Key.Meta (Uchar.of_char 'v')] "scroll-page-up"
  |> bind [Key.Page_down]        "scroll-page-down"
  |> bind [Key.Page_up]          "scroll-page-up"
  |> bind [Key.Scroll_down]      "scroll-line-down"
  |> bind [Key.Scroll_up]        "scroll-line-up"
